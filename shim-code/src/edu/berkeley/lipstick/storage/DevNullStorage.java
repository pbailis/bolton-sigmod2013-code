...
public class DevNullStorage implements IStorage {
    ...
    public DevNullStorage() throws Exception {
         writer = new FileWriter("/tmp/tweets.out");
    ...
    public void put(String key, byte[] value, long timestamp, boolean recordLat) throws Exception {  bytesWritten += value.length; bw.write(String.format("%d\n", value.length)); }
